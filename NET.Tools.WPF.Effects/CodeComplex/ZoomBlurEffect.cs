...
namespace NET.Tools.WPF.CodeComplex
{
    ...
    public class ZoomBlurEffect : ShaderEffect
    {
        ...
        /// </summary>
        public static readonly DependencyProperty BlurAmountProperty = DependencyProperty.Register("BlurAmount", typeof(double), typeof(ZoomBlurEffect), new UIPropertyMetadata(-0.1, PixelShaderConstantCallback(1)));
        ...
        static ZoomBlurEffect()
        {
            ...
            pixelShader.UriSource = Global.GetPackageUri("CodeComplex/Shader/ZoomBlur.ps");
        }
