    ...
    public class ToonShaderEffect : ShaderEffect
    {
        ...
        public static readonly DependencyProperty InputProperty =
            ShaderEffect.RegisterPixelShaderSamplerProperty(
                "Input", typeof(ToonShaderEffect), 0);

        public static readonly DependencyProperty FactorProperty = 
            DependencyProperty.Register(
                "Factor", 
                typeof(float), 
                typeof(ToonShaderEffect),
                new UIPropertyMetadata(3f, PixelShaderConstantCallback(0)));
        ...
        static ToonShaderEffect()
        {
            ...
            pixelShader.UriSource = Global.GetPackageUri("CodeComplex/Shader/ToonShader.ps");
