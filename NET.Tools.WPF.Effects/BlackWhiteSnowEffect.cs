...
namespace NET.Tools.WPF
{
    ...
    /// @{
    /// </summary>
    public class BlackWhiteSnowEffect : PixelShaderEffectBase
    {
        #region Static
        ...
        private readonly static PixelShader shader =
            new PixelShader()
            {
                UriSource = new Uri(@"pack://application:,,, /NET.Tools.WPF.Effects;component/Shader/BlackWhiteSnowShader.ps")
            };
