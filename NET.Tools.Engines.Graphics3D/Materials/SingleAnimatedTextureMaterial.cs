...
namespace NET.Tools.Engines.Graphics3D
{
    ...
    /// <summary>
    /// Represent a single animated texture material
    /// </summary>
    public abstract class SingleAnimatedTextureMaterial : AnimatedMaterial
    {
        protected IList<Texture> textures = new List<Texture>(8);
        ...
        internal SingleAnimatedTextureMaterial(double length)
            : base(length)
        {
        }
